...
Imagine being stranded on an alien planet, where you encounter an extraterrestrial gesticulating and emitting sounds.
This creature seems to be trying to communicate with you, and you decide your survival may depend on learning what they are talking about.
After producing a wide variety of sounds and gestures, the alien ...
Nonetheless, it is unclear to you exactly which aspect of the scene the alien is referring to. 
You struggle to disambiguate which sounds (words) refer to which referents, but you have trouble remembering any but the most recent and frequent words, and most often pointed to referents. 
