...
In the cross-situational word learning paradigm [@Smith2008], a learner acquires word meanings by tracking the co-occurrences words and objects across situations containing several words and objects. 
For example, adults are presented with a series of study trials, each displaying four uncommon objects (e.g., an abstract sculpture) while four pseudowords are spoken (e.g., "manu", "bosa"). 
